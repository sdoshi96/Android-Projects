...
import static com.example.android.news24.NewsActivity.LOG_TAG;
...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // for that news.
            JSONArray resultsNewsArray = newsObject.getJSONArray("results");

            // For each news in the resultNewsArray, create an {@link News} object
            for (int i = 0; i < resultsNewsArray.length(); i++) {
                ...
                if (currentNews.has("sectionName")) {
                    ...
                    category = "No Section Name Available";
                }
                ...
                // Create a new {@link News} object with the title, category,
                // and url from the JSON response.
                News news_object = new News(title, category, url);
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> news_json = extractFeatureFromJson(jsonResponse);
