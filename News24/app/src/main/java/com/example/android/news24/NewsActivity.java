...
public class NewsActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {
    ...
    private static final String KEY = "0448dbd8-e2ef-4979-a0bf-ce1c3e9f0e32";
    ...
    public void onLoadFinished(Loader<List<News>> loader, List<News> news) {
        ...
        // Set empty state text to display "No news currently available."
        mEmptyStateTextView.setText(R.string.no_news);
        // Clear the adapter of previous news data
        mAdapter.clear();

        // If there is a valid list of {@link News}, then add them to the adap\/ data set. This will trigger the ListView to update.
