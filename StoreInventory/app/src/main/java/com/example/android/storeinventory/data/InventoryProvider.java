...
/**
 * {@link ContentProvider} for Pr0ducts app.
 */
public class InventoryProvider extends ContentProvider {
    ...
    /**
     * URI matcher code for the content URI for a single product in the prodcuts table
     */
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.storeinventory/product" will map to the
        ...
        // For example, "content://com.example.android.storeinventory/product/3" matches, but
        // "content://com.example.android.storeinventory/product" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // For an example URI such as "content://com.example.android.storeinventory/product/3",
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (quantity == null && quantity < 0) {
            throw new IllegalArgumentException("Needs to enter a quantity");
        }
